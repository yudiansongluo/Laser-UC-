...
//		USART3_printf("Save_Data.UTCTime = ");
//		USART3_printf(Save_Data.UTCTime);
//		USART3_printf("\r\n");
		...
		if(Save_Data.isUsefull)
		{
		 gpssendflag=1;
			Save_Data.isUsefull = false;
					//	latitude
//			USART3_printf("Save_Data.latitude = ");
//			USART3_printf(Save_Data.latitude);
//			USART3_printf("\r\n");
...
//			USART3_printf( gpsp);
		...
		//	longitude
//			USART3_printf("Save_Data.longitude = ");
//			USART3_printf(Save_Data.longitude);
//			USART3_printf("\r\n");
...
//			USART3_printf( gpsp1);
		...
		{
//			USART3_printf("GPS DATA is not usefull!\r\n");
//			USART3_printf(Save_Data.GPS_Buffer);
		}
